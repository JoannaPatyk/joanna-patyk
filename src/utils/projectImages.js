...
import rocketImage from '../images/yellow-rocket.png';
import planetImage from '../images/violet-planet.png';
import yellowCloudImage from '../images/yellow-cloud.png';
...
const projectImages = [
    ...
    { id: 1, src: starsImage, className: 'project-images project-stars3-image', alt: 'Gwiazdy' },
    { id: 2, src: starsImage, className: 'project-images project-stars4-image', alt: 'Gwiazdy' },
    { id: 3, src: rocketImage, className: 'project-images project-rocket-image', alt: 'Rakieta' },
    { id: 4, src: planetImage, className: 'project-images project-planet-image', alt: 'Planet' },
    { id: 5, src: yellowCloudImage, className: 'project-images project-cloud-image', alt: 'Chmura' },
    { id: 6, src: yellowCloudImage, className: 'project-images project-cloud4-image', alt: 'Chmura' },
